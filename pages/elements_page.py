...
class TextBoxPage(BasePage):
    ...
    def check_field_from(self):
        full_name = self.element_is_present(self.locators.CREATED_FULL_NAME).text.split(':')[1]
        email = self.element_is_present(self.locators.CREATED_EMAIL).text.split(':')[1]
        current_address = self.element_is_present(self.locators.CREATED_CURRENT_ADD).text.split(':')[1]
...
class RadioButtonPage(BasePage):
    ...
    def click_one_the_radio_button(self, choice):
...
class UploadAndDownloadPage(BasePage):
    ...
    def download_file(self):
        ...
        path_name_file = f'/Users/mihailprocenko/PycharmProjects/selenium_pet_project/filetest{random.randint(0, 999)}.jpg'
